...
base='http://yomamam.com'
ADDON=xbmcaddon.Addon(id='plugin.video.BigmocoWizard')
...
def CATEGORIES():
    link = OPEN_URL('http://pastebin.com/raw/CxbkV1dA').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=aqua]Bigmoco Wizard[/COLOR]","[COLOR=red]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')
